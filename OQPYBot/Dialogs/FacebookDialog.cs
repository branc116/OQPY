        ...
        public static readonly IDialog<string> dialog = Chain
            ...
            .Switch(
                ...
                }, (ctx, msg) =>
                {
                    ...
                    return Chain.ContinueWith(new SimpleFacebookAuthDialog(),
                                async (context, res) =>
                                {
                                    ...
                                    context.UserData.SetValue(_name, name);
                                    context.UserData.SetValue(_facebookToken, token);
                                    var up = await _api.ApiUsersPostWithHttpMessagesAsync(token);
                                    return Chain.Return($"Your are logged in as: {name} {up.Body}");
                                });
                }),
                new Case<IMessageActivity, IDialog<string>>((msg) =>
                {
                ...
                }, (ctx, msg) =>
                {
                    ...
                    ctx.UserData.RemoveValue(_facebookToken);
